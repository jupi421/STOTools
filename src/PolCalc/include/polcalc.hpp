...
static inline double getSquaredDistance(const Position &atom_1,
...
static inline void getNNAll(const AtomPositions &atom_arr,
	...
	NNIdSqDist ref_atom_Sr_ids { findNNearest(ref_atom, atom_arr.SrPositions, n, ref_atom_id, true, cell_matrix, sort) };
	NNIdSqDist ref_atom_Ti_ids { findNNearest(ref_atom, atom_arr.TiPositions, n, ref_atom_id, false, cell_matrix, sort) };
	NNIdSqDist ref_atom_O_ids { findNNearest(ref_atom, atom_arr.OPositions, n, ref_atom_id, false, cell_matrix, sort) };
...
static inline void getNN(const Positions &atom_arr, 
						 ...
						 const std::optional<Eigen::Matrix3d>
						 &cell_matrix = std::nullopt,
						 const bool sort = false) {
